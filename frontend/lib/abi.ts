...
export const WORMHOLE_PROTOCOL_ABI = [
  {
    type: "constructor",
    inputs: [
    ...
    outputs: [
      {
        name: "values",
        type: "tuple",
        internalType: "struct ZkWormholeERC20.PublicValuesStruct",
        components: [
  ...
  {
    type: "function",
    name: "getDeadHashAmount",
    inputs: [{ name: "h", type: "bytes32", internalType: "bytes32" }],
    outputs: [{ name: "", type: "uint256", internalType: "uint256" }],
    stateMutability: "view",
  },
  {
  ...
  { type: "error", name: "ProofIsAlreadyUsed", inputs: [] },
  {
    type: "error",
